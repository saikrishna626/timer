...
function displayBg(hours){
    ...
    if(hours>=6 && hours<=19){
            document.getElementById("bg").style.backgroundImage="url('../images/2.jpg')"
          
    }
    else{
        
            document.getElementById("bg").style.backgroundImage="url('../images/1.jpg')"
            document.getElementById("bg").style.color="purple"   
